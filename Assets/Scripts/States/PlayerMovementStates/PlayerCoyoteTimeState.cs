...
public class PlayerCoyoteTimeState : PlayerMovementState
{
    public override PlayerMovementStateType Type { get; } = PlayerMovementStateType.CoyoteTime;
    ...
    public PlayerCoyoteTimeState(CommandSystem commandSystem, Player player) : base(commandSystem, player)
    {
    }
